...
import { WithCode } from '@components/react/WithCode/index.ts';
...
import ExampleRadioButtonCssRaw from './_ExampleRadioButton.module.css?raw';

<WithCode client:load code={[
  { filename: 'ExampleRadioButton.tsx', lang: 'tsx', code: ExampleRadioButtonRaw },
  { filename: 'ExampleRadioButton.module.css', lang: 'css', code: ExampleRadioButtonCssRaw },
]}>
  <ExampleRadioButton />
</WithCode>
...
import ExampleRadioCardCssRaw from './_ExampleRadioCard.module.css?raw';

<WithCode client:load code={[
  { filename: 'ExampleRadioCard.tsx', lang: 'tsx', code: ExampleRadioCardRaw },
  { filename: 'ExampleRadioCard.module.css', lang: 'css', code: ExampleRadioCardCssRaw },
]}>
  <ExampleRadioCard />
</WithCode>
...
import ExampleRadioCardHorizontallyCssRaw from './_ExampleRadioCardHorizontally.module.css?raw';

<WithCode client:load code={[
  { filename: 'ExampleRadioCardHorizontally.tsx', lang: 'tsx', code: ExampleRadioCardHorizontallyRaw },
  { filename: 'ExampleRadioCardHorizontally.module.css', lang: 'css', code: ExampleRadioCardHorizontallyCssRaw },
]}>
...
import ExampleCheckboxCssRaw from './_ExampleCheckbox.module.css?raw';

<WithCode client:load code={[
  { filename: 'ExampleCheckbox.tsx', lang: 'tsx', code: ExampleCheckboxRaw },
  { filename: 'ExampleCheckbox.module.css', lang: 'css', code: ExampleCheckboxCssRaw },
]}>
  <ExampleCheckbox />
</WithCode>
